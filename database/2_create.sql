...
ALTER TABLE recipe_allergen ADD CONSTRAINT recipe_allergen_recipe
...
ALTER TABLE recipe ADD CONSTRAINT recipe_course
...
ALTER TABLE recipe ADD CONSTRAINT recipe_image
    FOREIGN KEY (image_id)
        REFERENCES image (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE recipe_allergen ADD CONSTRAINT recipeallergen_allergen
